...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-e3uxm6a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-e3uxm6a.containers.anotherwebservice.com/
...
```
git clone git@github.com:explorer92/container-e3uxm6a.git
cd container-e3uxm6a
```
...
```
docker attach container-e3uxm6a
```
